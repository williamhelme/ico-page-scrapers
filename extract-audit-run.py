...
enforcement_data = scrape_page('https://ico.org.uk/action-weve-taken/audits-and-overview-reports/?facet_date=last_month')
export_to_xlsx(enforcement_data, "AUDITS")